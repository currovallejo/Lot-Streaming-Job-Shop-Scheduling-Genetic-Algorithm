...
def spc1_crossover(ind1, ind2):
    """
    Perform SPC-1 crossover by exchanging the portions to the left of the crossover point
    ...
    crossover_point = random.randint(1, len(ind1)- 1)  # Avoid 0 to ensure at least some crossover
...
def spc2_crossover(ind1, ind2):
    """
    Perform SPC-2 crossover by exchanging the portions to the right of the crossover point
    ...
    # Perform the crossover by exchanging the portions to the right of the crossover point
    new_ind1[crossover_point:] = ind2[crossover_point:]
    new_ind2[crossover_point:] = ind1[crossover_point:]
...
def cxPartialyMatched_mod(ind1, ind2):
    ...
    Individuals are transformed to list of integers for the crossover and then back to list of tuples.
