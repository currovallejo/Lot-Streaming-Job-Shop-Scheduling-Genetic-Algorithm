...
class GA:
    ...
    Attributes:
        my_params (dict): Parameters for the genetic algorithm.
    ...
    def initialize_DEAP(self):
        ...
        def create_individual_factory():
            ...
            def create_individual():
                return chromosome_generator.generate_chromosome(self.my_params)
        ...
        def evaluate_individual(individual):
            ...
            decoded_chromosome = decoder.decode_chromosome(
                individual, self.my_params, self.shifts, self.seq_dep_setup
            )
    ...
    def run(self, show_evolution=True):
        ...
        df_results = decoder.get_dataframe_results(
            best_individual, self.my_params, self.shifts, self.seq_dep_setup
        )
...
def main():
    ...
    plotting_ga.plot_solution_evolution(genetic_algorithm.fitness_scores)
