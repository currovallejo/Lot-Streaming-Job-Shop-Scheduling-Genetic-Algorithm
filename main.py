...
# --------- MAIN FUNCTIONALITY ---------
logger = init_logger()
problem_params = params.JobShopRandomParams(config_path="config/jobshop/js_params_01.yaml")
problem_params.print_jobshop_params(save_to_excel=False)

GA = GeneticAlgorithm(problem_params, logger, config_path="config/jobshop/ga_config_01.yaml")
